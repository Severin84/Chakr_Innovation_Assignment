...
import Allcompanies from './subcomponents/Allcompanies';
...
const page  = () => {
  ...
  return (
    <div style={{display:"flex"}}>
      <div style={{display:"flex",flexDirection:"column",width:"3vw",height:"100vh",justifyContent:"space-between",borderRight:"0.1rem",borderStyle:"solid"}}>
        <div>
